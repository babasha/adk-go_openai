...
[![Go Doc](https://img.shields.io/badge/Go%20Package-Doc-blue.svg)](https://pkg.go.dev/github.com/jiatianzhao/adk-go-openai)
...
```bash
go get github.com/jiatianzhao/adk-go-openai
```
